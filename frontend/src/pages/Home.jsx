    ...
    <div className="min-h-screen flex flex-col bg-linear-to-br from-slate-50 via-white to-slate-100">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16 animate-slideUp">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
              Manage Flatmate{" "}
              <span className="text-yellow-300 animate-pulse">Drama</span> with{" "}
              <span className="text-red-200 animate-pulse">Humor</span>
            </h1>
            <p className="text-xl md:text-2xl text-white mb-8 max-w-3xl mx-auto font-semibold leading-relaxed">
              Turn those silly roommate conflicts into a hilarious game. File
              complaints, vote on justice, and earn karma points!
            </p>
            <div className="flex gap-4 justify-center flex-wrap">
              <Link
                to="/register"
                className="px-8 py-4 bg-white text-indigo-700 rounded-2xl font-bold text-lg hover:bg-yellow-100 transition transform hover:scale-110 shadow-lg-custom hover:shadow-glow duration-300"
              >
                🚀 Get Started Free
              </Link>
              <Link
                to="/login"
                className="px-8 py-4 bg-indigo-900 text-white rounded-2xl font-bold text-lg hover:bg-indigo-950 transition transform hover:scale-110 shadow-lg-custom border-2 border-white duration-300"
              >
                Sign In
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20">
            <div className="bg-white bg-opacity-50 backdrop-blur-md rounded-2xl p-8 border-2 border-white text-center hover:bg-opacity-30 transition transform hover:scale-105 duration-300 shadow-lg-custom">
              <div className="text-5xl font-bold text-yellow-300 mb-3 animate-bounce-gentle">
                10K+
              </div>
            ...
            <div className="bg-white bg-opacity-50 backdrop-blur-md rounded-2xl p-8 border-2 border-white text-center hover:bg-opacity-30 transition transform hover:scale-105 duration-300 shadow-lg-custom">
              <div className="text-5xl font-bold text-red-300 mb-3 animate-bounce-gentle">
                50K+
              </div>
              <p className="text-indigo-900 font-bold text-lg">
                Complaints Filed
            ...
            <div className="bg-white bg-opacity-50 backdrop-blur-md rounded-2xl p-8 border-2 border-white text-center hover:bg-opacity-30 transition transform hover:scale-105 duration-300 shadow-lg-custom">
              <div className="text-5xl font-bold text-green-300 mb-3 animate-bounce-gentle">
                95%
              </div>
              <p className="text-indigo-900 font-bold text-lg">
                Conflicts Resolved
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-bold mb-4 text-gray-900">
              Why Choose QuirkyRoomie?
            </h2>
            <p className="text-center text-gray-600 text-xl font-semibold">
              Everything you need to manage flat conflicts with style and humor
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-linear-to-br from-blue-50 to-blue-100 rounded-3xl p-8 border-2 border-blue-300 hover:shadow-lg-custom transition transform hover:-translate-y-3 duration-300 group">
              ...
              <p className="text-gray-700 leading-relaxed">
                Document household issues with detailed descriptions, severity
                levels, and suggested punishments. Keep a record of everything!
              </p>
            </div>
            ...
            <div className="bg-linear-to-br from-red-50 to-red-100 rounded-3xl p-8 border-2 border-red-300 hover:shadow-lg-custom transition transform hover:-translate-y-3 duration-300 group">
              ...
              <p className="text-gray-700 leading-relaxed">
                Let your flatmates upvote or downvote complaints. See what the
                majority thinks and settle disputes democratically!
              </p>
            </div>
            ...
            <div className="bg-linear-to-br from-green-50 to-green-100 rounded-3xl p-8 border-2 border-green-300 hover:shadow-lg-custom transition transform hover:-translate-y-3 duration-300 group">
              ...
              <p className="text-gray-700 leading-relaxed">
                Build your reputation by resolving complaints and making fair
                judgments. Climb the leaderboard and become a legend!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="relative">
              <div className="absolute -left-5 top-0 w-10 h-10 bg-linear-to-br from-indigo-600 to-indigo-800 text-white rounded-full flex items-center justify-center font-bold text-lg shadow-lg">
                1
              </div>
              <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-300 ml-4 hover:shadow-lg-custom transition duration-300 transform hover:-translate-y-2">
                ...
                <p className="text-gray-600 font-semibold">
                  Set up your flat and invite flatmates to join
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-300 ml-4 hover:shadow-lg-custom transition duration-300 transform hover:-translate-y-2">
                ...
                <p className="text-gray-600 font-semibold">
                  Report household problems with details
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-300 ml-4 hover:shadow-lg-custom transition duration-300 transform hover:-translate-y-2">
                ...
                <p className="text-gray-600 font-semibold">
                  Your flatmates vote on the situation
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-300 ml-4 hover:shadow-lg-custom transition duration-300 transform hover:-translate-y-2">
                ...
                <p className="text-gray-600 font-semibold">
                  Get karma points when issues are resolved
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-linear-to-r from-indigo-700 via-indigo-800 to-indigo-900 text-white py-24 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-white font-semibold mb-10 leading-relaxed">
            Join thousands of flatmates who've turned their conflicts into
            comedy gold.
          </p>
          <Link
            to="/register"
            className="inline-block px-12 py-4 bg-white text-indigo-700 rounded-2xl font-bold text-lg hover:bg-yellow-100 transition transform hover:scale-110 shadow-lg-custom hover:shadow-glow duration-300"
          >
